      ...
      if (_0x4dbcb0) {
        ...
        if (_0x1e75d9 === "1.1") {
          await _0xaf8db8.sendMessage(_0x5eb615, {
            ...
            'caption': "*© Gᴇɴʀᴇʀᴀᴛᴇᴅ Bʏ ᴀʏᴀɴ ᴍᴏᴅᴢ*"
          }, {
            'quoted': _0x2405c0
          });
        } else {
...
cmd({
  ...
  try {
    ...
    let _0x5dfef2 = await fetchJson("https://www.dark-yasiya-api.site/download/phub?url=" + _0xa91317);
            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "ᴀʏᴀɴ ᴍᴏᴅᴢ | " + _0x1d0aed.title + '.mp4',
                  'caption': _0x1d0aed.title + " |  *ǫᴜᴇᴇɴ ɴᴇsᴋᴏ *\n\n> ©>ᴀʏᴀɴᴍᴏᴅᴢ"
                }, {
                  'quoted': _0x171143
                });
              } else {
  ...
  try {
    ...
    if (_0x43e539) {
      ...
      await _0x58a7b9.sendMessage(_0x5b710a, {
        ...
        'caption': "*© Gᴇɴᴇʀᴀᴛᴇᴅ Bʏ ǫᴜᴇᴇɴ ɴᴇsᴋᴏ*\n\n> 2025 • ᴀʏᴀɴᴍᴏᴅᴢ✻"
      }, {
        'quoted': _0x5afcc4
      });
    }
