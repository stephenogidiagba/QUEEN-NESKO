  ...
  try {
    ...
    _0x5351f6.ev.on("messages.upsert", async _0x11c496 => {
      ...
      if (_0x3cf2a8) {
        ...
        const _0x1cc9d0 = await fetchJson('https://vajira-official-api.vercel.app/download/ytmp3?url=' + _0x5ed25e);
        ...
        if (_0x5f20ab === '1') {
          ...
          await _0x5351f6.sendMessage(_0x3277a3, {
            ...
            'caption': "\n> *© Gᴇɴᴇʀᴀᴛᴇᴅ ꜰᴏʀ ʏᴏᴜ Bʏ Qᴜᴇᴇɴ ɴᴇsᴋᴏ❤️*\n "
          }, {
            'quoted': _0x25ddf5
          });
          await _0x5351f6.sendMessage(_0x3277a3, {
      ...
      if (_0x5e3294) {
        ...
        if (_0x1acf8d === "1.1") {
          ...
          await _0x2a6587.sendMessage(_0x5cd381, {
            ...
            'caption': "\n* Gᴇɴᴇʀᴀᴛᴇᴅ ꜰᴏʀ Yᴏᴜ Bʏ Qᴜᴇᴇɴ ɴᴇsᴋᴏ❤️*\n"
          }, {
            'quoted': _0x3dce21
          });
          await _0x2a6587.sendMessage(_0x5cd381, {
...
cmd({
  ...
  try {
    ...
    reply("*_Qᴜᴇᴇɴ ɴᴇsᴋᴏ downloading your song...🔍_*");
    ...
    const apiUrl = `https://vajira-official-api.vercel.app/download/ytmp3?url=${videoUrl}`;
